...
class EvaluationGridRepository extends Repository
{
    ...
    {
        try {
            $sql = "SELECT survey.id, evaluationgrids.name as name FROM evaluationgrids
    ...
    {
        try {
            $sql = "SELECT survey.id, evaluationgrids.name as name, rating_section.id as rating_section_id, 
